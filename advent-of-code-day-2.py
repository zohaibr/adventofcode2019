...
def findNounAndVerb(input_arr, result):
   for noun in range(100):
      for verb in range(100):
         input_arr[1] = noun
         input_arr[2] = verb
         output = createIntCodeProgram(input)
         if (output == result):
            print('noun: ', noun)
            print('verb: ', verb)
            return (noun, verb)
...
findNounAndVerb(input, 19690720)